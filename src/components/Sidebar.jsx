  ...
  return (
    <div className="h-dvh">
      ...
      <aside
        ...
        className=" w-fit p-4 h-[95vh] lg:h-[104.5vh] xl:h-[114.5vh] 2xl:h-[133.7vh] transition-transform lg:translate-x-0 lg:relative fixed z-20 bg-default-50 shadow-xl"
        aria-label="Sidebar"
      >
        <button
          onClick={() => {
